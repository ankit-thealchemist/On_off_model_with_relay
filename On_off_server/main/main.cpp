...
void example_ble_mesh_generic_server_cb(esp_ble_mesh_generic_server_cb_event_t event, esp_ble_mesh_generic_server_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT:
            ...
            param->ctx.recv_op == ESP_BLE_MESH_MODEL_OP_GEN_ONOFF_SET_UNACK)
        {
            ...
            gpio_set_level((gpio_num_t)ledPin, param->value.state_change.onoff_set.onoff);
        }

        break;

        // below events will never be called is get and set auto_rsp set to     ESP_BLE_MESH_SERVER_AUTO_RSPs
